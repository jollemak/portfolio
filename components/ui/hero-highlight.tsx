...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[40rem] w-full items-center justify-center bg-gray-950 overflow-hidden rounded-2xl",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-[#f33844] to-[#eb0d1cff] px-1 pb-1 dark:from-[#7a3e42] dark:to-[#ff6b76]`,
        className
      )}
    >
      {children}
