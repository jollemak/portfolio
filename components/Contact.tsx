            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between group">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">+358 404157752</span>
                </div>
                <button
                  onClick={() => copyToClipboard("+358 404157752", "phone")}
              ...
              <div className="flex items-center justify-between group">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">joel.wasaweb@gmail.com</span>
                </div>
                <button
                  onClick={() =>
                    copyToClipboard("joel.wasaweb@gmail.com", "email")
                  }
                  className="opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-700 rounded"
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between group">
                ...
                <button
                  onClick={() =>
                    copyToClipboard(
                      "https://www.linkedin.com/in/joel-m%C3%A4kel%C3%A4-0301491b7/",
                      "linkedin"
                    )
                  }
                  className="opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-700 rounded"
              ...
              <div className="flex items-center justify-between group">
                ...
                <button
                  onClick={() =>
                    copyToClipboard("https://github.com/jollemak", "github")
                  }
                  className="opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-700 rounded"
