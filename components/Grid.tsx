...
const projects = [
  {
    ...
    header: (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-orange-500 to-red-500"></div>
    ),
  ...
  },
  {
    ...
    header: (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-500 to-cyan-500"></div>
    ),
    className: "md:col-span-1",
  },
  {
    ...
    header: (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-purple-500 to-pink-500"></div>
    ),
    className: "md:col-span-1",
  },
  {
    ...
    header: (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-green-500 to-emerald-500"></div>
    ),
    className: "md:col-span-1",
  },
  {
    ...
    header: (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-yellow-500 to-orange-500"></div>
    ),
    className: "md:col-span-1",
  },
  {
    ...
    header: (
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-500"></div>
    ),
    className: "md:col-span-1",
  },
];
...
const Grid = () => {
  return (
    <div id="work" className="w-full max-w-6xl mx-auto px-4 py-12 md:py-16">
      <h2 className="text-3xl md:text-4xl font-light text-white text-center mb-6">
        My Projects
      </h2>
      <BentoGrid>
